...
app = {
    ...
    'macros' : [
        ...
        (0x1c2912, 'Missive', [Keycode.COMMAND, Keycode.OPTION, '5']),
        # 3rd row ----------
        (0x0d221c, 'Slack', [Keycode.COMMAND, Keycode.OPTION, '6']),
        (0x0f1d1c, 'Term.', [Keycode.COMMAND, Keycode.OPTION, '7']),
        (0x000000, 'VS Code', [Keycode.COMMAND, Keycode.OPTION, '8']),
        # 4th row ----------
